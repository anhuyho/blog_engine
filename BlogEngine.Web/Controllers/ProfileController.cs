...
namespace BlogEngine.Controllers
{
    public class ProfileController : Controller
    {
        ...
        {
            Content = @"<p>A son, a hushband, a father, a technical trainer and a software developer. 
                            <br>
                            <hr>
                            ...
                            <br>
                            </p><p>Skilled in </p><p>&nbsp;&nbsp;&nbsp;&nbsp;<strong>
                            C#, ASP.NET, Entity Framework (Core), Identity Server</strong></p><p>&nbsp; &nbsp; <b>Azure, Docker (Compose)</b><strong><br></strong></p><p>&nbsp;&nbsp;&nbsp;&nbsp;<strong>Javascript, jQuery, Angular JS, Vue JS, React JS</strong></p><p>
